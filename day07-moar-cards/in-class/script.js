...
var moarCardsSingleCardMain = function (input) {
  ...
  var singleCard = shuffledDeck.pop();

  console.log(singleCard);
  //how to extract information of an entire object {} instead of individual attributes
  var myOutputValue = `you have drawn ${singleCard.name} of ${singleCard.suit}`;
